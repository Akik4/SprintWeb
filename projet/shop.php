...
<body style="background: #100E2E;">
    ...
    <!-- <div class="grid text-center d-flex justify-content-evenly">
        <div class="g-col-4">
            <div><img src="../assets/img/ant_logo.png" alt=""></div>
            <div class="container">
                smigiob </div>
        </div>
        <div class="g-col-4">
    ...
    <div class="container d-flex justify-content-center">
        <div class="card m-3 border border-0" style="width: 18rem">
            <div class="p"></div>
            <img src="../assets/img/9900_3_2_05.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card m-3 border border-0" style="width: 18rem;">
            <img src="../assets/img/ant_logo.png" class="card-img-top" alt="...">
            <div class="card-body">
