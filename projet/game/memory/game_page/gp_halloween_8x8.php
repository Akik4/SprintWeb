...
<body>
            ...
            <div>
                <div class="headerGame">
                    <nav class="navbar">
                        ...
                        <div class="list">
                            <ul class="nav-element">
                                <li class="list-inactive" onclick="window.location='../index.html'">ACCUEIL</li>
                                <li class="list-inactive">JEU</li>
                                <li class="list-inactive" onclick="window.location='../score/score.html'">SCORE</li>
                                <li class="list-inactive" onclick="window.location='../contact/contact.html'">NOUS CONTACTER</li>
                            </ul>
                        </div>
                        <div class="nav-login">
                            <button><img src="../ressources/image/login.png" height="20px" width="20px" onclick="window.location = '../login/login.html'"></button>
                        </div>
                        <div class="space"></div>
    ...
    <div class="body_HOW">
        <table class="play">
            <tr>
                <td><img src="../assets/img/halloween logo.png" alt="ant_logo"></td>
                <td><img src="../assets/img/halloween logo.png" alt="ant_logo"></td>
                <td><img src="../assets/img/halloween logo.png" alt="ant_logo"></td>
                <td><img src="../assets/img/halloween logo.png" alt="ant_logo"></td>
                <td><img src="../assets/img/halloween logo.png" alt="ant_logo"></td>
