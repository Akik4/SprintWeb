...
<body>
    ...
    <div class="preview">
        <button onclick="window.location = '../game_page/game_page_ant_4x4.html'"><img src="../assets/img/4X4.jpg" alt="ant"></button>
        <button onclick="window.location = '../game_page/game_page_ant_8x8.html'"><img src="../assets/img/8X8.jpg" alt="ant"></button>
        <button onclick="window.location = '../game_page/game_page_ant_12x12.html'"><img src="../assets/img/12X12.png" alt="ant"></button>
    </div>
    <div class="footer">
        <div class="info">
